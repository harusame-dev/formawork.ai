...
export default function Page({ searchParams }: PageProps<"/tasks/new">) {
	const projectIdPromise = searchParams.then(({ projectId }) =>
		...
		<div className="container mx-auto p-2 space-y-4">
			...
			<Card className="p-4">
				<Suspense fallback={<RegisterTaskPageFormSkeleton />}>
					<RegisterTaskPageFormContainer projectIdPromise={projectIdPromise} />
				</Suspense>
			</Card>
		</div>
	);
