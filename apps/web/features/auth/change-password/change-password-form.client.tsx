...
import {
  type ChangePasswordParams as ChangePasswordParameters,
...
export function ChangePasswordForm({
  ...
  const form = useForm<ChangePasswordParameters>({
    defaultValues: {
      currentPassword: "",
      newPassword: "",
    },
  ...
  function onSubmit(values: ChangePasswordParameters): void {
