...
import type { EditCustomerParams as EditCustomerParameters } from "@/features/customer/edit/schema";
import { GENDER_LABELS, Gender } from "@/features/customer/schema";
import { registerCustomerAction } from "./register-customer.action";
import {
  type RegisterCustomerParams as RegisterCustomerParameters,
  registerCustomerSchema,
} from "./schema";

interface EditCustomerFormProps {
  customerId?: string;
  initialValues?: Omit<EditCustomerParameters, "customerId">;
}
...
export function EditCustomerForm(
  ...
  const form = useForm<RegisterCustomerParameters>({
  ...
  async function onSubmit(values: RegisterCustomerParameters): Promise<void> {
