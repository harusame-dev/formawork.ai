...
test("メールアドレスの形式が不正な場合、エラーが表示される", async () => {
	...
	// 不正な形式のメールアドレスを入力
	await page.getByRole("textbox", { name: /^姓\W必須$/ }).fill("テスト");
	await page.getByRole("textbox", { name: /^名\W必須$/ }).fill("太郎");
