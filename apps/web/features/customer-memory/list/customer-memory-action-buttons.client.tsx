...
import { DeleteCustomerMemoryDialog } from "../delete/delete-customer-memory-dialog.client";
import { EditCustomerMemoryDialog } from "../edit/edit-customer-memory-dialog.client";
