...
ALTER TABLE "customer_note_images"
ADD CONSTRAINT "customer_note_images_customer_note_id_customer_notes_customer_note_id_fk" FOREIGN KEY ("customer_note_id") REFERENCES "customer_notes" ("customer_note_id") ON DELETE cascade ON UPDATE no action;

ALTER TABLE "customer_note_advice"
ADD CONSTRAINT "customer_note_advice_customer_note_id_customer_notes_customer_note_id_fk" FOREIGN KEY ("customer_note_id") REFERENCES "customer_notes" ("customer_note_id") ON DELETE cascade ON UPDATE no action;
