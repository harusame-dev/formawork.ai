ALTER TABLE "customer_notes" RENAME COLUMN "id" TO "customer_note_id";
ALTER TABLE "customer_note_images" DROP CONSTRAINT "customer_note_images_customer_note_id_customer_notes_id_fk";

ALTER TABLE "customer_note_advice" DROP CONSTRAINT "customer_note_advice_customer_note_id_customer_notes_id_fk";
