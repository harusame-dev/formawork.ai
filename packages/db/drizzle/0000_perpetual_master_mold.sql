...
ADD CONSTRAINT "customer_note_images_customer_note_id_customer_notes_id_fk" FOREIGN KEY ("customer_note_id") REFERENCES "customer_notes" ("id") ON DELETE cascade ON UPDATE no action;

ALTER TABLE "customer_notes"
ADD CONSTRAINT "customer_notes_customer_id_customers_customer_id_fk" FOREIGN KEY ("customer_id") REFERENCES "customers" ("customer_id") ON DELETE cascade ON UPDATE no action;

ALTER TABLE "customer_notes"
ADD CONSTRAINT "customer_notes_staff_id_staffs_staff_id_fk" FOREIGN KEY ("staff_id") REFERENCES "staffs" ("staff_id") ON DELETE cascade ON UPDATE no action;

ALTER TABLE "customer_note_advice"
ADD CONSTRAINT "customer_note_advice_customer_note_id_customer_notes_id_fk" FOREIGN KEY ("customer_note_id") REFERENCES "customer_notes" ("id") ON DELETE cascade ON UPDATE no action;
