import { MEMORY_CATEGORY } from "../schema/customer-memory";

export const customerMemoriesFixture = [
	// テスト太郎さん (00000000-0000-0000-0000-000000000001)
	{
		category: MEMORY_CATEGORY.PERSONAL,
		content: "会社員、IT企業勤務",
	...
	{
		category: MEMORY_CATEGORY.PREFERENCE,
	...
	{
		category: MEMORY_CATEGORY.CONVERSION,
	...
	{
		category: MEMORY_CATEGORY.COMMUNICATION,
	...
	{
		category: MEMORY_CATEGORY.EVENT,
		content: "9月に結婚式出席予定",
		customerId: "00000000-0000-0000-0000-000000000011",
	...
	{
		category: MEMORY_CATEGORY.HEALTH,
		content: "頭皮の乾燥が気になる",
